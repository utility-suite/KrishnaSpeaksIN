import{b as M,d as P,f as D}from"./chunk-DWMLRN4O.js";import{j as A,k as C,m as L,n as O}from"./chunk-4XFBZI6S.js";import{$a as I,Ea as k,Ia as c,Ta as r,Ua as o,Va as a,Wa as d,Y as v,Z as x,_a as B,ab as T,db as S,eb as g,fb as E,gb as s,hb as m,ib as u,jb as h,kb as b,lb as F,nb as f,ob as y,qa as w,ra as p,ta as n,ya as _}from"./chunk-W2M4HXT4.js";var j=[{slug:"thoughtful-decision-making-guide",image:"assets/image/blog/DecisionMakingGuide.png",date:"2025-08-03",author:"Krishna Kumar Pandey",title:'"Pause Before You Decide" \u2013 A Thoughtful Guide to Better Decisions',description:"A practical, expressive guide on how to make mindful decisions by checking legality, balance, fairness, emotional impact, and long-term value. Powered by KrishnaSpeaksIN.",tags:["Decision Making","Life Skills","Self Growth"],content:[`<p class="mb-4">In our fast-paced world, decisions often come flying at us like arrows\u2014some small, like what to eat for dinner, and others life-altering, like switching careers, ending a relationship, or moving cities. While it\u2019s tempting to react instantly, <strong>the true strength lies in the pause</strong>\u2014a moment to reflect and ask yourself: <em>\u201CIs this really the right step?\u201D</em></p>
              ...
              <p class="mt-6">Stay thoughtful. Stay grounded. \u2014 <em>Krishna from KrishnaSpeaksIN</em></p>`]},{slug:"hindi-poem-sukoon-ki-talaash",image:"assets/image/blog/SukoonKiTalaash.png",date:"2025-07-27",author:"Krishna Kumar Pandey",title:'"\u0938\u0941\u0915\u0942\u0928 \u0915\u0940 \u0924\u0932\u093E\u0936" \u2013 \u090F\u0915 \u0939\u093F\u0902\u0926\u0940 \u0915\u0935\u093F\u0924\u093E',description:"\u091C\u0940\u0935\u0928 \u0915\u0940 \u091C\u0926\u094D\u0926\u094B\u091C\u0939\u0926, \u0909\u092E\u094D\u092E\u0940\u0926 \u0914\u0930 \u0938\u0941\u0915\u0942\u0928 \u0915\u0940 \u0924\u0932\u093E\u0936 \u092A\u0930 \u0906\u0927\u093E\u0930\u093F\u0924 \u090F\u0915 \u092D\u093E\u0935\u0941\u0915 \u0939\u093F\u0902\u0926\u0940 \u0915\u0935\u093F\u0924\u093E\u0964",tags:["\u0915\u0935\u093F\u0924\u093E"],content:[`<div class="text-center">
            ...
            </div>`]}];var Y=t=>["/blog",t];function z(t,i){if(t&1){let e=T();o(0,"button",6),S("click",function(){let K=v(e).$implicit,N=g(2);return x(N.filterByTag(K))}),s(1),a()}if(t&2){let e=i.$implicit,l=g(2);E("btn-primary",e===l.activeTag)("btn-outline-primary",e!==l.activeTag),n(),u(" ",e," ")}}function R(t,i){if(t&1&&(B(0),o(1,"h2",3),s(2,"The Thought Grid"),a(),o(3,"div",4),c(4,z,2,5,"button",5),a(),I()),t&2){let e=g();n(4),r("ngForOf",e.allTags)}}function U(t,i){if(t&1&&(o(0,"span",19),s(1),a()),t&2){let e=i.$implicit;n(),m(e)}}function G(t,i){if(t&1&&(o(0,"div",9)(1,"div",10),d(2,"img",11),o(3,"div",12)(4,"h5",13),s(5),a(),o(6,"p",14),s(7),f(8,"date"),a(),o(9,"div",15),c(10,U,2,1,"span",16),a(),o(11,"p",17),s(12),a(),o(13,"a",18),s(14," Read More "),a()()()()),t&2){let e=i.$implicit;n(2),r("alt",b(e.title))("src",e.image,p),n(3),m(e.title),n(2),h("",y(8,9,e.date,"longDate")," | ",e.author),n(3),r("ngForOf",e.tags),n(2),m(e.description),n(),r("routerLink",F(12,Y,e.slug))}}function $(t,i){if(t&1&&(o(0,"div")(1,"div",7),c(2,G,15,14,"div",8),a()()),t&2){let e=g();n(2),r("ngForOf",e.filteredBlogList)}}function H(t,i){if(t&1&&(o(0,"span",28),s(1),a()),t&2){let e=i.$implicit;n(),u(" ",e," ")}}function V(t,i){if(t&1&&(o(0,"div",20)(1,"button",21),s(2," \u2190 Back to Blogs "),a(),o(3,"div",22)(4,"h1",23),s(5),a(),o(6,"p",14),s(7),f(8,"date"),a(),o(9,"div",24),c(10,H,2,1,"span",25),a()(),d(11,"img",26),o(12,"div"),d(13,"article",27),a()()),t&2){let e=g();n(5),m(e.selectedBlog.title),n(2),h(" ",y(8,8,e.selectedBlog.date,"longDate")," \xA0|\xA0 ",e.selectedBlog.author," "),n(3),r("ngForOf",e.selectedBlog.tags),n(),r("alt",b(e.selectedBlog.title))("src",e.selectedBlog.image,p),n(2),r("innerHTML",e.selectedBlog.content,w)}}var W=class t{constructor(i){this.route=i;this.allTags=["All",...this.getUniqueTags()]}blogList=j;selectedBlog=null;activeTag="All";allTags=[];ngOnInit(){this.route.paramMap.subscribe(i=>{let e=i.get("slug");this.selectedBlog=e&&this.blogList.find(l=>l.slug===e)||null})}getUniqueTags(){let i=new Set;return this.blogList.forEach(e=>e.tags.forEach(l=>i.add(l))),Array.from(i)}filterByTag(i){this.activeTag=i}get filteredBlogList(){return this.activeTag==="All"?this.blogList:this.blogList.filter(i=>i.tags.includes(this.activeTag))}static \u0275fac=function(e){return new(e||t)(_(M))};static \u0275cmp=k({type:t,selectors:[["app-blog"]],decls:4,vars:3,consts:[[1,"container-fluid","p-md-5","py-5"],[4,"ngIf"],["class","container py-4 px-md-5",4,"ngIf"],[1,"fw-bold","mb-4","text-center"],[1,"d-flex","flex-wrap","gap-2","justify-content-center","mb-5"],["class","btn btn-sm text-capitalize",3,"btn-primary","btn-outline-primary","click",4,"ngFor","ngForOf"],[1,"btn","btn-sm","text-capitalize",3,"click"],[1,"row","row-cols-1","row-cols-md-3","g-4"],["class","col",4,"ngFor","ngForOf"],[1,"col"],[1,"card","h-100","shadow-sm","btn-outline-primary"],[1,"card-img-top",3,"src","alt"],[1,"card-body","text-center"],[1,"card-title"],[1,"small"],[1,"mb-2"],["class","badge bg-secondary me-1",4,"ngFor","ngForOf"],[1,"card-text"],[1,"btn","btn-outline-primary","btn-sm","btn-primary","text-light",3,"routerLink"],[1,"badge","bg-secondary","me-1"],[1,"container","py-4","px-md-5"],["routerLink","/blog",1,"btn","btn-outline-primary","mb-4"],[1,"text-center","mb-4"],[1,"fw-bold"],[1,"d-flex","flex-wrap","justify-content-center","gap-2","mt-2"],["class","badge rounded-pill bg-primary-subtle text-primary-emphasis",4,"ngFor","ngForOf"],[1,"img-fluid","rounded","shadow","mb-5","mx-auto","d-block","blog-image",2,"max-height","450px","object-fit","cover",3,"src","alt"],[3,"innerHTML"],[1,"badge","rounded-pill","bg-primary-subtle","text-primary-emphasis"]],template:function(e,l){e&1&&(o(0,"section",0),c(1,R,5,1,"ng-container",1)(2,$,3,1,"div",1)(3,V,14,11,"div",2),a()),e&2&&(n(),r("ngIf",!l.selectedBlog),n(),r("ngIf",!l.selectedBlog),n(),r("ngIf",l.selectedBlog))},dependencies:[D,P,O,A,C,L],styles:["h2[_ngcontent-%COMP%]{font-family:Poppins,sans-serif;font-weight:700;color:var(--text-color);text-align:center}.card[_ngcontent-%COMP%]{transition:transform .2s;background:var(--card-bg);color:var(--card-text)}.card[_ngcontent-%COMP%]:hover{transform:translateY(-5px)}.btn-outline-primary[_ngcontent-%COMP%]{border-color:var(--text-color);color:var(--text-color)}.blog-image[_ngcontent-%COMP%]{width:100%;max-width:600px;height:auto;object-fit:cover}@media (max-width: 576px){.blog-image[_ngcontent-%COMP%]{max-width:90%}}"]})};export{W as Blog};
